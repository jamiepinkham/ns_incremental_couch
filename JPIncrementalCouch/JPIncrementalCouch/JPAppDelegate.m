...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
	...
	JPMasterViewController *masterViewController = [[JPMasterViewController alloc] initWithNibName:@"JPMasterViewController" bundle:nil];
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"JPIncrementalCouch" withExtension:@"momd"];
